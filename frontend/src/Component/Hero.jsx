    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 h-full flex flex-col lg:flex-row items-center relative z-10">
        ...
        <div className="flex-1 text-center lg:text-left lg:pr-16" data-aos="fade-right">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-[5.5rem] min-[1700px]:text-[5rem] font-extrabold text-[#1A1A1A] leading-[1.1] sm:leading-[1] mb-8 tracking-tight" data-aos="fade-up">
          ...
          <p className="text-gray-500 text-lg lg:text-xl min-[1700px]:text-xl max-w-xl mx-auto lg:mx-0 mb-10 leading-relaxed font-medium" data-aos="fade-up" data-aos-delay="200">

...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen sm:min-h-[90vh] lg:min-h-screen bg-[#F0F7FF] pt-16 sm:pt-24 pb-0 lg:pb-12 overflow-hidden flex items-center"
    >
      {/* Background Elements */}
      ...
      <div className="max-w-7xl min-[1700px]:max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 w-full flex flex-col lg:flex-row items-center relative z-10 gap-8 sm:gap-0">
        ...
        <div className="flex-1 mt-10 sm:mt-20 lg:mt-0 relative w-full flex justify-center items-center" data-aos="fade-left">
